namespace OJ.Core
{
    ...
    public static class TowerFormula
    {
        ...
        /// 구간 마지막 층의 전투 강화석.
        ///
        /// <b>강화석을 고른 이유.</b> 소비처가 진화(10·20)와 속성강화(1·2·3…)뿐이라
        /// 수급이 곧 다이스 단계와 직결된다. 탑이 그 값을 대면 "탑을 올라 다이스를 키우고,
        /// 키운 다이스로 더 올라간다"는 7.2 의 순환이 재화 한 종류로 닫힌다.
        /// </summary>
        public static int BandRewardEnhanceStone(int floor)
        {
